...
${BIN_ROOT}${NAME1}: ${OBJS}
	${AT} ${CC} ${FLAGS} ${INCS} ${OBJS} -o $@ ${RDFLAG} ${BLOCK}
	${AT}printf "Object files created .................. ${_SUCCESS}\n" ${BLOCK}
	${AT}printf "Binary file compiled .................. ${_SUCCESS}\n" ${BLOCK}
	${AT}printf "Binary file ready ..................... ${_SUCCESS}\n" ${BLOCK}

${BIN_ROOT}${NAME2}: ${OBJS_T} $(filter-out objects/./main.o, ${OBJS})
	${AT} ${CC} ${FLAGS} ${INCS_T} ${OBJS_T} $(filter-out objects/./main.o, ${OBJS}) -o $@ ${RDFLAG} ${BLOCK}
